...
<div id="main-wrapper">
    <div class="panel panel-white">
        <div class="panel-body">
            <form method="POST" enctype="multipart/form-data" action="{{ route('addUserSave') }}" class="formSave">
                @csrf
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        ...
                        <select name="tier_user" id="tier_user" class="form-control select2" onchange="getRole()" required>
                            ...
                            <option value="{{ $tierKey }}"> {{ $tier }} </option>
                            @endforeach
                        </select>
                    </div>
                    <div class="col-md-3" style="display: none"  id="sub_dept_id_div">
                        <label for="dept_id">Sub Department <span style="color: red">*</span></label>
                        <select name="sub_dept_id" id="sub_dept_id" style="width:100%" class="form-control select2" required>
                            <option value="">Select</option>
